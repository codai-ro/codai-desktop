...
- **desktop**: v1 Windows build signed (updater pubkey), local release script, Cloudflare updater worker, release runbook, gateway probe (1c118397)
...
- **oss**: public-facing docs for phone, desktop, protocol + codai-ro org profile; local gitleaks-gated mirror script (94ed18f3)
